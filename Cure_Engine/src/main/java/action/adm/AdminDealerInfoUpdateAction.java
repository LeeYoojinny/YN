...
import svc.adm.AdminDealerInfoUpdateService;
import vo.ActionForward;
import vo.User;

public class AdminDealerInfoUpdateAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		AdminDealerInfoUpdateService dealerInfoUpdateService = new AdminDealerInfoUpdateService();
		boolean isUserUpdateSuccess = dealerInfoUpdateService.dealerUpdate(user);
		...
		if (isUserUpdateSuccess) {
            ...
            out.println("location.href='dealerInfoView.adm';"); 
            out.println("</script>");

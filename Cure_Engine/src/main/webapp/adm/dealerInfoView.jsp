...
<link rel="stylesheet" href="css/admin/dealerInfoView_style.css">
</head>
...
<body>
    <div class="wrap_join">
        ...
        <input type="hidden" name="user_category" value="dealer">
       		<div class="field id">
				<b>아이디<small>(자동생성, 변경불가) </small></b>
				<div>
				<input type="text" name="user_id" id="user_id" value="${userInfo.user_id}" readonly>
				</div>
			</div>
            <div class="field">
                <b>이름</b>
